...
<html>
    <head>
        ...
        <script src="assets/js/RTCDaddy.js"></script>
   ...
   <body style="padding:0;margin:0;overflow:hidden">
    ...
    <div id="bar" style="display:;position:fixed;bottom:50px;left:0;height:70px;width:100%;z-index:999999999999999999999999999999;text-align:center">
        ...
        <div id="local" style="position: absolute;display:none">
			<video id="myLocalVideo" autoplay="autoplay" muted="true" style="display:none;width:100%; position:absolute; left:0; right:0; top:0; bottom: 0; object-fit: cover; display: block"></video>
		</div>
        <div id="remote" style="position: absolute; width:100%; position:absolute; left:0; right:0; top:0; bottom: 0; object-fit: cover; display: block">
            <div id="myRemoteVideo" style="width:100%;position:absolute; left:0; right:0; top:0; bottom: 0; object-fit: cover; display: block"></div>
            <div style="display:none" id="mini">
				<video id="myMiniVideo" autoplay="autoplay" muted="true" style="width:100%; position:absolute; left:0; right:0; top:0; bottom: 0; object-fit: cover; display: block"></video>
			</div>
        </div>
	<span id="ctrl">
		...
		<div id="primitive" style="display:none; color:white;padding:10px;text-align:center;background:red;font-size:2em;font-family:Ubuntu Condensed;border-radius:6px;width:90%;margin:auto;position:absolute;left:0;right:0;top:750px"><blink>LINK UNSTABLE. RECONNECTING...</blink></div>
			...
			<script>
				...
				if (fr) {
					setCookie('login', fr)
					alert(fr)
					location.href='vim.php?to='+to
				}
				var resolution='HD'
				var bandwidth=300
				var webRTCClient
				
				if (!to) to=getCookie('to')
				document.getElementById('to').value=to

				if (to) setTimeout('callUser()',2000)
        ...
        function sessionReadyHandler(e) {
            ...
            webRTCClient = apiCC.session.createWebRTCClient({
				...
				var constraint = {
					...
					'video': {'mandatory': {maxWidth: 1920, maxHeight: 1080}, 'optional': []}
				};
